...
const getStyles = (colors) => StyleSheet.create({
  ...
  titleMeta: { color: colors.textSecondary, fontSize: 12, fontWeight: "500" },
  createButton: {
    minHeight: 44,
    borderRadius: 12,
  ...
  weekRangeText: { color: colors.brand, fontSize: 16, fontWeight: "700", textAlign: "center" },
  sectionTitleRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "flex-end",
  ...
  sectionTitle: { color: colors.brand, fontSize: 18, fontWeight: "800" },
  sectionMeta: {
    color: colors.muted,
    fontSize: 12,
    fontWeight: "600",
  ...
  categoryMarkText: { color: colors.brand, fontSize: 24, fontWeight: "800" },
  ...
  planCategory: { color: colors.accent, fontSize: 13, fontWeight: "600" },
  statusChip: {
  ...
  statusText: { color: colors.brand, fontSize: 12, fontWeight: "600" },
  planSubtitle: {
  ...
  missingDaysRow: { flexDirection: "row", flexWrap: "wrap", marginTop: 10 },
  missingDayChip: {
    minHeight: 28,
    flexDirection: "row",
    alignItems: "center",
  ...
  missingDayText: { color: colors.danger, fontSize: 12, fontWeight: "600" },
  fillMissingPill: {
    minHeight: 28,
    borderRadius: 8,
    backgroundColor: colors.dangerSubtle,
