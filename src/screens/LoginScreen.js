    ...
    <ScrollView contentContainerStyle={styles.content}>
      <View style={styles.card}>
        ...
        <AppText style={styles.subtext}>
          Sign in to continue your nutritional journey.
        </AppText>
      ...
      <AppText style={styles.footer}>© 2026 FitFood Go Systems.</AppText>
      <AppText style={styles.footer}>. BAHINTING | DORIN | MANALANG</AppText>
    </ScrollView>
  );
}
