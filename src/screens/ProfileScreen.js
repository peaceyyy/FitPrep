    ...
    >
      ...
      <View style={styles.infoCard}>
        ...
        <View style={styles.infoRowLast}>
          ...
          <AppText style={styles.infoValue}>
            {user.address || "No delivery address yet"}
          </AppText>
        </View>
      </View>
      ...
      <View style={styles.macroCard}>
        <View style={styles.infoHeader}>
          ...
          <AppText style={styles.planHint}>
            {macros.mealCount || 0} meals
          </AppText>
        </View>
        <View style={styles.macroGrid}>
          <View style={styles.macroItem}>
            ...
            <AppText style={styles.macroValue}>
              {formatMacro(macros.totals.calories, "")}
            </AppText>
          </View>
          <View style={styles.macroItem}>
            <AppText style={styles.macroLabel}>Avg / Meal</AppText>
            <AppText style={styles.macroValue}>
              {formatMacro(macros.average.calories, "")}
            </AppText>
          </View>
          <View style={styles.macroItem}>
            <AppText style={styles.macroLabel}>Protein</AppText>
            <AppText style={styles.macroValue}>
              {formatMacro(macros.totals.protein)}
            </AppText>
          </View>
          <View style={styles.macroItem}>
            <AppText style={styles.macroLabel}>Carbs / Fats</AppText>
            <AppText style={styles.macroValue}>
              {formatMacro(macros.totals.carbs)} /{" "}
              {formatMacro(macros.totals.fats)}
            </AppText>
          </View>
        </View>
        {recentPlanNames.length > 0 && (
          <AppText style={styles.planSummary}>
            Recent orders: {recentPlanNames.join(", ")}
          </AppText>
        )}
      </View>
